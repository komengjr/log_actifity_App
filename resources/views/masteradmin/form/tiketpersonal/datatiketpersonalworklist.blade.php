<div class="modal-header bg-info">
    <h5 class="modal-title text-white">Data Tiket Personal Worklist</h5> 
    <span>
...
<div class="modal-body" id="divtableuser">
    ...
    <div class="body pt-2" >
        <table class="styled-table" id="default-tiketpersonalworklist">
            <thead>
                <tr>
                    <th>No</th>
                    <th>no Tiket</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#default-tiketpersonalworklist').DataTable();
